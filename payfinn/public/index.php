<?php
	...
	$amount = 100;
	$refCode = "TEST000001";
	$scbDeepLinks = genSCBDeeplink($amount,$refCode,$scbAccessToken);
//var_dump($scbDeepLinks);
//exit;
	$deeplinkUrl = $scbDeepLinks['data']['deeplinkUrl'];
?>
			...
			<div class="container">	
				...
				<div class="col-md-7">
					...
					<div class="btn-group cart">
						<button type="button" class="btn btn-success" onclick="window.location.href='<?php echo $deeplinkUrl ?>'">
							Buy
						</button>
					</div>
				</div>
