<?php
    ...
    function genSCBDeeplink($amount,$refCode,$scbAccessToken)
    {
        $datas = [];
        ...
        $datas['billPayment']['accountTo'] = "015768847876768";
        $datas['billPayment']['ref1'] = $refCode;
        $datas['billPayment']['ref2'] = "01";
        $datas['billPayment']['ref3'] = "SCB";

        $datas['creditCardFullAmount']['merchantId'] = "430459283460796";
        $datas['creditCardFullAmount']['terminalId'] = "316577479545726";
        $datas['creditCardFullAmount']['orderReference'] = $refCode;
        $datas['creditCardFullAmount']['paymentAmount'] = $amount;

        $datas['installmentPaymentPlan']['merchantId'] = "430459283460796";
        $datas['installmentPaymentPlan']['terminalId'] = "316577479545726";
        ...
        $datas['merchantMetaData']['callbackUrl'] = "https://payfinn.glitch.me/public/success.php";
        $datas['merchantMetaData']['merchantInfo']['name'] = "TEST";
        ...
        CURLOPT_HTTPHEADER => array(
            'Content-Type: application/json',
            'authorization: Bearer '.$scbAccessToken,
            'resourceOwnerId: l793a52b5830274acb892356ea49b2740c',
            'requestUId: dd6b995f-9fe3-492e-b57c-4d44b6191ba1',
            'channel: scbeasy',
            'accept-language: EN',
